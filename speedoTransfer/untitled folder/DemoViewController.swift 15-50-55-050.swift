...
//MARK: - 1st EXTENSION
    ...
    extension DemoViewController {
        ...
        func setup(){
            ...
            let page1 = onboardingViewController(imageName: "error404", titleText: "Welcome", subtitleText: "Welcome to the first screen "
            )
            let page2 = onboardingViewController(imageName: "fast-loading", titleText: "Welcome", subtitleText: "Hello"
            )
            let page3 = onboardingViewController(imageName: "error404", titleText: "Welcome", subtitleText: "Hi, welcome to my first app"
            )
            let page4 = VC2()
            pages.append(page1)
            pages.append(page2)
